...
import { DetailsStyle, ProductInfo, Quantity, Buy, Price, Details, Line } from "../../styles/ProductDetails"
...
export default function ProductDetails() {
    ...
    return (
        ...
        <DetailsStyle>
            ...
            <Quantity>
            <span>Quantity</span>
            <button><AiFillMinusCircle onClick={reduceQty}/></button>
            <p>{qty}</p>
            <button><AiFillPlusCircle onClick={addQty}/></button>
            </Quantity>
            <Buy onClick={() => {
        ...
        <Details>
            ...
            <p>Duralon outsole with reinforced rubber at the heel for durable traction</p>
            <p>Vertical and horizontal flex grooves give you flexibility in all directions</p>
            <p>FullHlength Phylon midsole and Air-Sole heel unit provide lightweight cushioning</p>
        </Details>
        <footer>
